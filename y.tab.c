...
union YYSTYPE
{
#line 53 "compiler_hw3.y" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "STRING", "INC", "DEC", "GEQ", "LOR", "LAND", "ADD_ASSIGN", "SUB_ASSIGN",
  "IF", "ELSE", "FOR", "SWITCH", "CASE", "PRINT", "INT_LIT", "STRING_LIT",
  "$accept", "Program", "GlobalStatementList", "GlobalStatement",
  "PackageStmt", "FunctionDeclStmt", YY_NULLPTR
};
#endif
...
#line 105 "compiler_hw3.y" /* yacc.c:1906  */
